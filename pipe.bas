...
Public Function FixStr2Bytes(a$) As String
Dim b As Long, i As Long, z As Long, ad As Long
b = Len(a$)
If b Mod 2 = 1 Then
    FixStr2Bytes = StrConv(String$(b, Chr(0)), vbFromUnicode)
Else
    FixStr2Bytes = String$((b + 1) \ 2, Chr(0))
End If
ad = StrPtr(FixStr2Bytes)
z = StrPtr(a$)
For i = ad To ad + b - 1
    MemByte(i) = MemByte(z)
    z = z + 2
Next
End Function
Public Function FixBytes2String(a$) As String
Dim b As Long, i As Long, z As Long, ad As Long
b = LenB(a$)
FixBytes2String = space$(b)
ad = StrPtr(FixBytes2String)
z = StrPtr(a$)
For i = z To z + b - 1
    MemByte(ad) = MemByte(i)
    ad = ad + 2
Next
End Function
