...
Version 12 Revision 52 active-X
A Bug removed (this bug happen at last two revisions)
This is the test code (the \\ok was not interpreted as comment):
MODULE TT {?"OK"}
tt \\OK
? "OK TOO"

Now the code run as expected.
