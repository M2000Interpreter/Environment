...
"RATN(", 125, "атон.еж(", 125, "PLAYVALUE(", 126, "паифеианиа(", 126, "PLAYVOLUME(", 127, "паифеиемтасг(", 127, "PLAYNOTE(", 128, "паифеимота(", 128, "PLAYNOW(", 129, "паифеитыяа(", 129, "PLAYDOTS(", 130, "паифеитекеиес(", 130, "PLAYGATE(", 131, "паифеипоята(", 131, "PLAYTUPLET(", 132, "паифеисвгла(", 132)
