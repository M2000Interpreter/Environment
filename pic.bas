...
End Select
End Function
Function IsLambda(a$) As Boolean
IsLambda = True
Select Case myUcase(a$, True)
Case "калда", "калда$"
Case "LAMBDA", "LAMBDA$"
Case Else
IsLambda = False
...
Case "WITH", "WITHEVENTS", "WORDS", "WRITABLE(", "WRITE", "WRITER", "X.TWIPS", "XOR", "Y.TWIPS", "аццкийа", "адеиас", "аниысг", "апеияо", "апой.ая$(", "апой.ая(", "апой.де$(", "апой.де("
Case "адеиасе", "аежап(", "агл(", "ахя(", "ай(", "айеяаио.дуадийо(", "айеяаио", "айеяаиос", "айеяаиос[", "акт", "акгхес", "акгхгс", "аккацг", "аккацг$(", "аккацг("
...
Case "апко", "апкос", "апкос[", "апо", "апохгйеусг.ыс", "апой$(", "апой(", "апойопг", "апойкеистийа", "апок(", "аяца", "аяихло", "аяихлос", "аяихлос[", "аяихлос.паяацяажоу("
Case "аяис$(", "аяис(", "аяистеяолеяос$(", "аяистеяолеяос(", "аявеиа", "аявеио", "аявеио$(", "аявеиоу.лгйос(", "аявеиоу.сталпа(", "аявг", "аявг(", "асум(", "атон.еж(", "атупо", "атупос", "аукос"
...
Case "цяажг$(", "цяажг(", "цяаье", "цягцояа", "цымиа", "дапед(", "деийтг.лояжг", "деийтгс", "деийтгс(", "деийтгс.йол", "деийтгс.ь", "деийтгс.у", "деийтгс.в"
...
Case "йукисг", "йуяио", "йуяио.еяцо", "йыд(", "йыдийа", "йыдийас(", "йыдийосекида", "кабг", "кабг(", "кабг.амакоцийо.у(", "кабг.амакоцийо.ь("
Case "кабг.амакоцийо.в(", "кабг.йатеухумсг(", "кахос", "кахос$", "кахос.таимиас$", "кахым", "калда", "калда(", "калда$", "калда$(", "катимийа", "кенеис", "киста", "коц("
Case "коцийо", "коцийос", "коцистийо", "коцистийос", "коцистийос[", "коцос", "коцос$(", "кс$", "кж(", "лафи(", "лафеье(", "лайяу", "лайяус", "лайяус[", "ле", "ле.амтийеилемо", "лец(", "лец$(", "лецако("
...
Case "лекыдиа", "леяос", "леяос(", "леяос$(", "лес$(", "лес(", "лета", "летабкгтг", "летабкгтес", "летахесг", "летахесг(", "летяо(", "левяи", "лгдемийос", "лгйос", "лгйос(", "лгйос.елж("
Case "лицадийос", "лицадийос[", "лий(", "лий$(", "лийяо(", "лийяо.сеияас$(", "лийяо.сеияас(", "лийяос.йатакоцос$(", "лмглг", "ломадиаио", "ломадиаиос", "ломадийо", "лояжг$(", "лояжг(", "лоусийг", "лоусийг.летягтгс", "лпип"
...
Case "тилг(", "тилг$(", "тилгсыяоу$(", "тилгсыяоу(", "типота", "титкос", "титкос$(", "титкос(", "тлгла", "тлгла(", "тлгла$", "тлглата", "томос"
Case "тон.еж(", "топийа", "топийес", "топийг", "топийо", "топийо$(", "топийо(", "топос$(", "топос.аявеиоу$("
Case "тоте", "тяап(", "тупос", "тупос$(", "тупос(", "тупос.аявеиоу$(", "тупысе", "туваиос", "туваиос(", "тыяа", "у.сглеиа", "укийо("
...
Case "жяасг", "жымг", "жыто$(", "в.сглеиа", "вая$(", "вая(", "ваяайтгяес", "ваяане", "ваяйыд$("
...
, "MEMORY", 16, "лмглг", 16, "CHARSET", 17, "ваяайтгяес", 17, "ITALIC", 18, "ITALICS", 18, "пкациа", 18, "BOLD", 19, "жаядиа", 19, "COLORS", 20, "вяылата", 20 _
