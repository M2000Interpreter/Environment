...
If TEXT1.BlockEndPos > TEXT1.BlockStartPos Then
l = TEXT1.BlockStartPos
Else
l = TEXT1.BlockEndPos
End If
Else
...
If TEXT1.SelLength > 0 Then
If TEXT1.BlockEndPos > TEXT1.BlockStartPos Then
l = TEXT1.BlockStartPos + Len(s$)
Else
l = TEXT1.BlockEndPos + Len(s$)
End If
Else
...
Case vbKeyReturn
        ...
        If TEXT1.glistN.WWWLink Then
            If InStr(TEXT1.SelText, vbCr) = 0 Then
                If InStr(TEXT1.SelText, "://") > 0 Then
                    'RaiseEvent www(SelText)
                    TEXT1_WWW TEXT1.SelText
                    KeyCode = 0
                    shift = 0
                    Exit Sub
                End If
...
Else
    If Left$(TEXT1.CurrentParagraph, 2) <> "//" Then
        If gList1.UseTab Then
            ...
            TEXT1.SelStartSilent = where + 3
        Else
            TEXT1.SelStartSilent = ii
            If TabControl > 2 Then
            TEXT1.RemoveUndo "//" + space$(TabControl - 2)
            TEXT1.InsertText = "//" + space$(TabControl - 2)
    ...
    ElseIf gList1.UseTab Then
        TEXT1.SelStartSilent = ii
        If Left$(TEXT1.CurrentParagraph, 3) <> "//" + vbTab Then
            TEXT1.SelLengthSilent = 2
            TEXT1.RemoveUndo "//"
            TEXT1.InsertText = vbNullString
            If (where - 2) > ii Then
                    TEXT1.SelStartSilent = where - 2
                Else
                    TEXT1.SelStartSilent = ii
            End If
        Else
...
' *****************************
    ...
    FFONT = MyFont
    Err.Clear
    DIS.Font.charset = Me.Font.charset
    DIS.FontName = MyFont
    DIS.Font.Italic = False
    DIS.FontName = MyFont
    If Err.Number > 0 Then
...
DIS.Font.bold = Font.bold
TEXT1.Font.charset = Font.charset
TEXT1.Font.bold = Font.bold
List1.Font.charset = Font.charset
List1.Font.bold = Font.bold
Else
...
If lightconv(TEXT1.BackColor) < lightconv(TEXT1.ForeColor) Then
TEXT1.ColorSet = 0
Else
TEXT1.ColorSet = 1
End If
...
If Not aForm Is Nothing Then
    If TypeOf aForm Is GuiM2000 Then aForm.UNhookMe
    Set zz = aForm
End If
...
If aForm Is MyPopUp Then
   ...
   Else
    NeoMsgBox.Show , Me
     MoveFormToOtherMonitorOnly NeoMsgBox, True
   End If
ElseIf aForm Is Form1 Then
NeoMsgBox.Show , aForm
MoveFormToOtherMonitorOnly NeoMsgBox, False
ElseIf Not aForm Is Nothing Then
On Error Resume Next
Unload NeoMsgBox
Load NeoMsgBox
NeoMsgBox.Show , aForm
...
If IsWine Then
    ...
    End If
Else
If Forms.Count < 6 Then mywait11 Basestack1, 5 'SleepWaitEdit bstack, 30
End If
If AskInput Then
...
On Error Resume Next
Dim safety1 As Long
While Not NeoMsgBox.Visible And safety1 < 2000
    NeoMsgBox.Visible = True
    Err.Clear
    ProcTask2 bstack
    safety1 = safety1 + 1
Wend
Modalid = mycode
If Not NeoMsgBox.Visible Then GoTo cont11
If INFOONLY Then
...
Public Function NeoAskBad(bstack As basetask) As Double
If ASKINUSE Then Exit Function
On Error GoTo recover
Dim safety As Long, XX As GuiM2000
Dim oldesc As Boolean, zz As Form
...
NeoAskBad = 1
Else
NeoAskBad = Abs(AskCancel$ = vbNullString) + 1
End If
If NeoAskBad = 1 Then
If AskInput Then
bstack.soros.PushStr AskStrInput$
